...
#ifndef RECO_GRIDALLHITS_H
#define RECO_GRIDALLHITS_H

namespace reco
{
  class GridAllHits: public plgn::Reconstructor
  {
    public:
      GridAllHits(const plgn::Reconstructor::Config& config);
      virtual ~GridAllHits() = default;
